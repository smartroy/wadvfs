...
thermal_config_t default_thermal_config(void)
{
	...
	config.s_sink =60e-3;// 60e-3;				/* heatsink side in m	*/
	...
	/* heat spreader specs	*/
	config.s_spreader = 30e-3;//0.03 m for 90nm//60e-3;//30e-3;			/* spreader side in m	*/
	...
	config.r_convec_sec = 5-.0;
	config.c_convec_sec = 40.4; //FIXME! need updated value.
	config.n_metal = 8;
	config.t_metal = 100.0e-6;
	config.t_c4 = 0.0001;
	config.s_c4 = 20.0e-6;
	config.n_c4 = 400;
	config.s_sub = 0.021;
